...
%      plotatoms=1;
  ...
  %          case  'N', color = [1.0 0.3 1.0]; r = 0.4;
            case  'C', color = [0 1 0]; r = 0.5;
            case  'O', color = [1 0 0]; r = 0.5;
            case  'N', color = [0 0 1	]; r = 0.4;
            otherwise, color = [1.0 0.0 0.0]; r = 0.5;
            end
        else
            switch mol.labels(ii)
            case  'H', color = [0.7 0.7 0.7]; r = 0.3;
            case  'C', color = [0.5 0.5 0.5]; r = 0.5;
            case  'O', color = [0.4 0.4 0.4]; r = 0.5;
            case  'N', color = [1.0 1.0 1.0]; r = 0.4;
            otherwise, color = [1.0 1.0 1.0]; r = 0.5;
            end
        end
      	if fl_plotlines
          	r=r*0.1;
