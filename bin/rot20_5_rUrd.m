% deleted Cyd from Cyt and and uridine base to to resulted sugar conformation and make ribouridine anti and syn conformations
%
% Version 1.0    
...
afile = 'r90003_Uridine_in.xyz'
fullafilename=[CD.templatesdir filesep afile]
aH1 = 1; %indexes of glycosidic bond atoms %H1
aN1 = 2; %N1
aC2 = 3;
aC6 = 9;
...
%    plotmol(mc2,'g');
    fi = p2pangle(createplane(ms0,iH12,ms0,iC1,ms0,ibN1),createplane(mc2,aC6,mc2,aN1,mc2,aC2));
