%convert dAdo unique conformations to dO8Ado ones by changing H8 to O8 and adding H7 at 0.9A from N7
%
% Version 1.0    
...
for i=sortind
    ...
    ms0.pind(ind) = find(strcmp(pind.labels,'bCO8'));
    ms0.labels(ind)={'O'};
...
%    dist=1.084;
    ...
    ms0.pind(end+1)=find(strcmp(pind.labels,'bH7'));
