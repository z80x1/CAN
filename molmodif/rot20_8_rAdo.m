% delete guanine from Gua and add adenine base to to resulted sugar conformation and make riboadenosine anti and syn conformations
%
% Version 1.0    
...
workdbname=[CD.dbdir filesep 'r340_g_dftV2_or.mat']
workname='r14002';
...
%    maxind=ms0.atomnum;
    ...
    vect_sug = createvect(ms0,iC1,ms0,ibN9);
...
%    plotmol(mc2,'g');
    fi = p2pangle(createplane(ms0,iH12,ms0,iC1,ms0,ibN9),createplane(mc2,aC6_C8,mc2,aN1_N9,mc2,aC2_C4));
