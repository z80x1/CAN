...
if flexportgeom
    ...
    savemode     %#ok
    workname = [ 'r' int2str(moltype) '_xyz_' theory] %#ok %output workname
...
if exist([odir filesep 'includelist'],'file')
	includelist.do=1;    %#ok
else
	includelist.do=0;    %#ok
end
...
if exist([odir filesep 'excludelist'],'file')
	excludelist.do=1;    %#ok
else
	excludelist.do=0;    %#ok
end
...
sortmode=2  %#ok %(0/1/2 - without sorting/sort by sdesc/energy)
