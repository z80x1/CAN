function xlswrite1spec(file,data,sheet,range,params)
%
% Version 1.0    
% Last modified  R O Zhurakivsky 2006-08-20
% Created        R O Zhurakivsky 2006-?-?

%060620 ZHR: created by mixing xlswritespec by Chand and xlswrite1 by Matt Swartz
%original source is xlswrite by JP Barnard
%params(1).Italic attribute added
%try-catch block during applying params attributes added
%060622 ZHR: check for underfined 'params' added 
...
try
    ...
    % SET FOR THE SELECTION CERTAIN PARAMETERS //from xlswritespec.m Chand version
    try
    if ~isempty(params)
        Excel.selection.Font.Bold = params(1).Bold;
        Excel.selection.Font.Italic = params(1).Italic;
        ...
        warning('xlswrite:erinparams','Error in params. Not applied');
    end
