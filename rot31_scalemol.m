%rot31_scalemol: purposes:
%1) scale fractional cell coordinates to angsrems 
%2) try to build entire crystal cell
...
%DDA Hutcheon 1974  Acta Cryst.  (1974). B30,  1777 
%workdir='D:\_diplom\docs\articles\_crystalstructure\DDA';
%fname='DDA_crdata_Hutcheon.CCgeom'; moltype=112

%2011-0419
%d4G Van Roey P., Chu C.K. Nucleosides, Nucleotides and Nucleic Acids, 11: 6, 1229—1239 (1992)
workdir='D:\_diplom\data\_crystalstructure\d4G';
fname='d4G_crdata_Roey.CCgeom'; moltype=312
...
elseif moltype==112 %DDA_Hutcheon
    %orthorhombic  space  group P 2_1 2_1 2_1 
    cell_a=10.035;%Ang
    cell_b=13.863;%Ang
    cell_c=7.830;%Ang
    cell_beta=90;%deg
...
elseif moltype==312 %d4G_Roey
    %monoclinic space group P 2_1 
    cell_a= 16.429;%Ang
    cell_b= 9.179;%Ang
    cell_c= 10.864;%Ang
    cell_beta= 101.49;%deg
